...
namespace Binding
{
    public readonly struct UnityEngineVector3Bind : ISerialize<UnityEngine.Vector3>, ISerialize
    {
        ...
        public unsafe void Read(ref UnityEngine.Vector3 value, ISegment stream)
        {
        ...
        public void Bind()
        {
            SerializeCache<UnityEngine.Vector3>.Serialize = this;
        }
    }
}
...
namespace Binding
{
    public readonly struct SystemCollectionsGenericListUnityEngineVector3Bind : ISerialize<System.Collections.Generic.List<UnityEngine.Vector3>>, ISerialize
    {
        ...
        public void Bind()
        {
            SerializeCache<System.Collections.Generic.List<UnityEngine.Vector3>>.Serialize = this;
        }
    }
}
