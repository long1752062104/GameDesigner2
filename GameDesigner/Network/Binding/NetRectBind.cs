...
namespace Binding
{
    public readonly struct NetRectBind : ISerialize<Net.Rect>, ISerialize
    {
        ...
        public unsafe void Read(ref Net.Rect value, ISegment stream)
        {
        ...
        public void Bind()
        {
            SerializeCache<Net.Rect>.Serialize = this;
        }
    }
}
...
namespace Binding
{
    public readonly struct SystemCollectionsGenericListNetRectBind : ISerialize<System.Collections.Generic.List<Net.Rect>>, ISerialize
    {
        ...
        public void Bind()
        {
            SerializeCache<System.Collections.Generic.List<Net.Rect>>.Serialize = this;
        }
    }
}
