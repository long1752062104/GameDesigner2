...
namespace Net.System
{
    ...
    /// 内存数据片段
    /// </summary>
    public struct ArraySegment : IDisposable, ISegment
    {
        /// <summary>
        /// 总内存
        /// </summary>
        ...
        public ArraySegment(byte[] buffer) : this(buffer, 0, buffer.Length)
        {
        }
        ...
        /// </summary>
        /// <param name="buffer"></param>
        public ArraySegment(byte[] buffer, bool isRecovery) : this(buffer, 0, buffer.Length, isRecovery)
        {
        }
        ...
        public ArraySegment(byte[] buffer, int index, int count, bool isRecovery = true)
        {
            Buffer = buffer;
            Offset = index;
            Count = count;
        ...
        {
            return new ArraySegment(buffer);
        }
