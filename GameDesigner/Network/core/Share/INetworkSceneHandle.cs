namespace Net.Share
{
    ...
    public interface INetworkSceneHandle<Player, Scene> where Player : NetPlayer where Scene : NetScene<Player>
    {
        ...
        /// <returns></returns>
        Scene CreateScene(Player player, string sceneID, Scene scene);
        ...
        /// <returns></returns>
        Scene JoinScene(Player player, string sceneID);
        ...
        /// <param name="sceneID">场景ID，要切换到的场景号或场景名称</param>
        /// <returns></returns>
        Scene EnterScene(Player player, string sceneID);
        ...
        /// <param name="sceneID">场景ID，要切换到的场景号或场景名称</param>
        /// <returns></returns>
        Scene SwitchScene(Player player, string sceneID);
