...
namespace Net.Server
{
    ...
    {
        #region 不异步时内置Token
        public void Response(uint protocol, bool serialize, params object[] pars)
        ...
        public void Response(byte cmd, uint protocol, params object[] pars)
            => Call(cmd, protocol, true, false, Token, null, pars);

        public void Response(string func, bool serialize, params object[] pars)
        ...
        public void Response(byte cmd, string func, params object[] pars)
        ...
        public void Call(byte cmd, Enum protocol, params object[] pars)
            => Call(cmd, (uint)protocol.GetHashCode(), true, false, 0, null, pars);
        public void Response(Enum protocol, bool serialize, uint token, params object[] pars)
            => Call(NetCmd.CallRpc, (uint)protocol.GetHashCode(), true, serialize, token, null, pars);
        public void Response(Enum protocol, uint token, params object[] pars)
            => Call(NetCmd.CallRpc, (uint)protocol.GetHashCode(), true, false, token, null, pars);
        public void Response(byte cmd, Enum protocol, uint token, params object[] pars)
            => Call(cmd, (uint)protocol.GetHashCode(), true, false, token, null, pars);

        public void Response(Enum protocol, bool serialize, params object[] pars)
            => Call(NetCmd.CallRpc, (uint)protocol.GetHashCode(), true, serialize, Token, null, pars);
        public void Response(Enum protocol, params object[] pars)
            => Call(NetCmd.CallRpc, (uint)protocol.GetHashCode(), true, false, Token, null, pars);
        public void Response(byte cmd, Enum protocol, params object[] pars)
            => Call(cmd, (uint)protocol.GetHashCode(), true, false, Token, null, pars);
        #endregion
    }
}